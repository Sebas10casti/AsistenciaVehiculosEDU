...
class Vehiculo(models.Model):
    ...
    serial = models.CharField("Serial (bicicleta)", max_length=80, blank=True, null=True)
    ...
    def __str__(self):
        iden = self.placa or self.serial or ""
...
class Registro(models.Model):
    ...
    def __str__(self):
        return f"{self.vehiculo} - {self.fecha} - entrada:{self.hora_entrada} salida:{self.hora_salida}"
